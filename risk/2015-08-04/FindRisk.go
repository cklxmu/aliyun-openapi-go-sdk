...
func (r *FindRiskRequest) SetUmid(value string) {
	r.Umid = value
	r.QueryParams.Set("Umid", value)
}
func (r *FindRiskRequest) GetUmid() string {
	return r.Umid
}
func (r *FindRiskRequest) SetExtend(value string) {
	r.Extend = value
	r.QueryParams.Set("Extend", value)
}
func (r *FindRiskRequest) GetExtend() string {
	return r.Extend
}
...
type FindRiskResponse struct {
	...
	Data struct {
		...
		VerifyType   string `xml:"VerifyType" json:"VerifyType"`
		VerifyDetail string `xml:"VerifyDetail" json:"VerifyDetail"`
	} `xml:"Data" json:"Data"`
}
